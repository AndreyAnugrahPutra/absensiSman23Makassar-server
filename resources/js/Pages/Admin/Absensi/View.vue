    ...
    <AdminLayout pageTitle="Absensi">
        <template #pageContent>
            ...
            <DataTable v-model:filters="filters" ref="dt" paginator :rows="10" :value="dataAbsenFix" removableSort scrollable
             size="small" stripedRows tableStyle="min-width: 50rem" class="mt-4" v-if="pageProps.dataAbsen.length > 0">
                <template #header>
                ...
                <template #empty>
                    <Message severity="secondary">Tidak ada data</Message> 
                </template>
            ...
            <Message severity="secondary" class="mt-8" v-else>Tidak Ada Data Absen</Message>
        </template>
    </AdminLayout>
</template>
