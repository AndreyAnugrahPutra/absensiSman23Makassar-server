...
const form = useForm({
    ...
    og_foto_profil : dataProfilTemp.foto_profil,
    og_foto_path : dataProfilTemp.foto_path,
...
{
    form.post(`/guru/profile/`+pageProps.dataProfil[0]['user_id']+`/update`, {
        onFinish : () => {
            form.reset()
            checkNotif()
        },
...
<template>
    <Head title="Guru Profile" />

    <GuruLayout pageTitle="Profile">
            ...
            <form submit.prevent class="flex flex-col gap-8 py-8">
                ...
                <div class="flex items-center md:flex-wrap gap-x-[8rem] gap-y-6 px-4">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <InputText v-model="form.password" id="password" class="flex-auto" autocomplete="off" placeholder="silahkan isi untuk mengganti password"/>
                    </div>
                    <div class="flex items-center gap-4">
                ...
                <div class="flex flex-col gap-2">
                    <Button label="Update Profile" severity="info" @click="uploadDataGuru" :disabled="form.processing"/>
                </div>
            </form>
        </template>
    </GuruLayout>
